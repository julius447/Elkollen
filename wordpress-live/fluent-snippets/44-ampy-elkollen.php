...
* @tags: 
* @group: 
* @name: Ampy - Elkollen - JS Engine
* @type: js
* @status: published
* @created_by: 13
* @created_at: 2026-06-11 08:35:57
* @updated_at: 2026-07-22 00:23:14
* @is_valid: 1
* @updated_by: 13
* @priority: 10
* @run_at: wp_footer
...
/**
 * Ampy - Elkollen - JS Engine  (v7.3.8)
 * Fluent Snippets: Frontend, wp_footer.
 *
 * Verbatim from Julius's v7.3.8 standalone engine (assets/behorighetskollen.js),
 * wrapped in the live double-load guard. Reads window.AmpyBK.data (injected inline
 * by the render function) + window.AmpyBK.restUrl/restNonce (WP REST lead submit,
 * already upstream in v7.3.8) and boots on DOMContentLoaded over any .ampy-bk mount.
 */
if (window._AmpyBkLoaded) { /* another copy already ran */ }
else {
  window._AmpyBkLoaded = true;
