...
function ampy_bk_dynamic_og() {
    ...
    foreach ( $data['jobs'] as $j ) {
        ...
        // v7.2: the 10 direct-verdict jobs are type:fixed (default_verdict red)
        // and the 5 scenario forks keep their default_verdict, so their
        // per-verdict OG image stays correct; the 11 originally-conditional
        // jobs (no default) fall back to yellow.
        $og_url = '';
